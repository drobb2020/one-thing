  ...
  return (
    <>
      ...
      >
        <input
          type="text"
          className="bg-inherit rounded-md text-slate-800 font-sans py-2 px-6 focus:outline-none text-xl sm:text-2xl placeholder:text-slate-400 caret-teal-600 appearance-none w-fill"
          ...
          onInput={handleInput}
        />
        <button className="bg-inherit rounded-md text-slate-800 font-sans py-2 px-6 focus:outline-none focus:text-teal-600 hover:text-teal-600">
